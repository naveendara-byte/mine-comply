import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, B as Button, T as Trees, a as TableSkeleton, u as ue } from "./index-TQY_iKlQ.js";
import { P as Plus, I as Input, F as FormModal } from "./input-nHBbGSn7.js";
...
import { m as useTreeRecords, n as useAddTreeRecord, o as useDeleteTreeRecord, p as useTreeSpeciesSummary } from "./useBackend-V3w6Lpe4.js";
import { C as ChevronUp, e as ChevronDown } from "./index-CLCQYvXI.js";
/**
...
function SummaryCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5 flex items-center gap-4", children: [
...
function SpeciesBreakdown({ totalCount }) {
    ...
    Card,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base font-display font-semibold flex items-center gap-2", children: [
          ...
          "Species Breakdown",
          summary && summary.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "text-xs font-normal ml-1", children: [
            summary.length,
            " species"
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableSkeleton, { rows: 4 }) }) : !summary || summary.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "px-6 pb-6 text-center text-muted-foreground text-sm",
            "data-ocid": "trees.species_breakdown.empty_state",
            children: "No species data yet."
          }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/40 hover:bg-muted/40", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-xs font-semibold text-muted-foreground", children: "Species" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-xs font-semibold text-muted-foreground text-right", children: "Count" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-xs font-semibold text-muted-foreground text-right", children: "% of Total" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-xs font-semibold text-muted-foreground min-w-[120px]", children: "Distribution" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: summary.map((s, i) => {
            const pct = totalCount > 0 ? (Number(s.totalCount) / totalCount * 100).toFixed(1) : "0.0";
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              TableRow,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right font-mono font-semibold text-foreground", children: Number(s.totalCount).toLocaleString() }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: "text-right font-mono text-muted-foreground", children: [
                    pct,
                    "%"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 rounded-full bg-muted overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    TableHead,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1", children: [
        label,
        active ? sortDir === "asc" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "h-3 w-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-3 w-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "h-3 w-3 opacity-30" })
      ] })
    }
  );
}
function TreesPage() {
  ...
  const [sortField, setSortField] = reactExports.useState("plantingDate");
  ...
  const speciesSet = reactExports.useMemo(
    () => new Set((records ?? []).map((r) => r.species)).size,
    [records]
  );
  const latestDate = reactExports.useMemo(() => {
    if (!records || records.length === 0) return null;
    const max = records.reduce(
      (a, b) => a.plantingDate > b.plantingDate ? a : b
    );
  ...
  const filtered = reactExports.useMemo(() => {
    ...
    if (q) {
      rows = rows.filter(
        (r) => r.species.toLowerCase().includes(q) || r.location.toLowerCase().includes(q) || r.plantedBy.toLowerCase().includes(q)
      );
    }
    rows.sort((a, b) => {
      let cmp = 0;
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      ue.success("Tree record added successfully");
      setModalOpen(false);
      setForm(EMPTY_FORM);
    } catch {
      ue.error("Failed to add tree record");
    }
  }
  async function handleDelete() {
    ...
    try {
      ...
      ue.success("Tree record deleted");
    } catch {
      ue.error("Failed to delete tree record");
    } finally {
      setDeleteId(null);
    }
  }
      ...
      children: [
          ...
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                SummaryCard,
                {
                  icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-5 w-5" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpeciesBreakdown, { totalCount })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border bg-card", "data-ocid": "trees.log.card", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-3 flex flex-row items-center justify-between gap-4 flex-wrap", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base font-display font-semibold flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Trees, { className: "h-4 w-4 text-primary" }),
                  "Tree Planting Log",
                  !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "ml-1 text-xs font-normal", children: [
                    filtered.length,
                    " record",
                    filtered.length !== 1 ? "s" : ""
                  ] })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableSkeleton, { rows: 6 }) }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "flex flex-col items-center justify-center py-16 text-center px-6",
                  "data-ocid": "trees.log.empty_state",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Trees, { className: "h-12 w-12 text-muted-foreground/30 mb-3" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-medium text-muted-foreground", children: search ? "No records match your search" : "No tree records yet" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground/70 mt-1", children: search ? "Try a different species or location" : "Click “Add Tree Record” to log your first planting." }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/40 hover:bg-muted/40", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-xs font-semibold text-muted-foreground", children: "Location" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SortTH,
                    {
                      field: "count",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-xs font-semibold text-muted-foreground", children: "Planted By" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: filtered.map((rec, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  TableRow,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Badge,
                        {
                          ...
                          children: rec.species
                        }
                      ) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm text-foreground font-medium whitespace-nowrap", children: formatDate(rec.plantingDate) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm text-foreground max-w-[180px] truncate", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 min-w-0", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3 w-3 text-muted-foreground flex-shrink-0" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: rec.location })
                      ] }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right font-mono font-semibold text-foreground", children: Number(rec.count).toLocaleString() }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm text-foreground", children: rec.plantedBy }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm text-muted-foreground max-w-[160px] truncate", children: rec.notes || /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "opacity-40", children: "—" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          variant: "ghost",
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "tree-species", children: [
                      "Species ",
                    ...
                    errors.species && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "tree-date", children: [
                      "Planting Date ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    errors.plantingDate && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        className: "text-xs text-destructive",
                        "data-ocid": "trees.planting_date.field_error",
                        children: errors.plantingDate
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 sm:col-span-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "tree-location", children: [
                      "Location ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "tree-count", children: [
                      "Count ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "tree-planted-by", children: [
                      "Planted By ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    errors.plantedBy && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        className: "text-xs text-destructive",
                        "data-ocid": "trees.planted_by.field_error",
                        children: errors.plantedBy
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 sm:col-span-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "tree-notes", children: "Notes" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Textarea,
                      {
                        id: "tree-notes",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          AlertDialog,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { "data-ocid": "trees.delete.dialog", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Delete Tree Record" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { children: "This will permanently remove this planting record. This action cannot be undone." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { "data-ocid": "trees.delete.cancel_button", children: "Cancel" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  AlertDialogAction,
                  {
